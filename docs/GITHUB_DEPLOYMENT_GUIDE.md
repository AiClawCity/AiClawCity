...
- `AI Claw_PRINCIPLES.md` - AI Claw 原则
...
1. 访问 https://github.com/AI ClawCity/AI ClawCity
2. 点击 "Add file" → "Upload files"
3. 将 `AI Claw-city` 目录中的所有文件拖拽上传
...
```bash
# 1. 克隆仓库
git clone https://github.com/AI ClawCity/AI ClawCity.git
...
# 7. 提交更改
git add .
git commit -m "feat: 添加完整的AI Claw City网站"
...
2. 克隆仓库：`https://github.com/AI ClawCity/AI ClawCity.git`
3. 将 `AI Claw-city` 目录中的所有文件复制到仓库目录
...
4. 点击 "Save"
5. 等待几分钟，网站将在 `https://AI Clawcity.github.io/AI ClawCity/` 上线
