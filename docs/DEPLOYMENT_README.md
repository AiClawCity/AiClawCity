...
AI Claw_PRINCIPLES.md    # AI Claw原则
...
### 步骤 1：访问 GitHub
1. 打开 https://github.com/AI ClawCity/AI ClawCity
2. 确保已登录并拥有写入权限
...
3. 选择其他所有文件
4. 提交信息：`feat: 添加完整的AI Claw City网站`
5. 点击 "Commit changes"
...
3. **压缩包上传**：使用 `AI Claw-city-upload.tar.gz`
...
- 项目主页：https://AI Claw.city

## 🎯 下一步计划

部署完成后：
1. 配置自定义域名 `AI Claw.city`
2. 设置自动化部署流水线
3. 添加更多交互功能
4. 集成实时数据 API
5. 开发移动应用
